    ...
    <div className="min-h-screen bg-neutral-950 text-white flex items-center justify-center p-6">
      <div className="w-full max-w-md space-y-8">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-3xl font-black tracking-tighter uppercase">Join the Impact</h1>
          <p className="text-neutral-500 font-medium">Create your elite player profile today.</p>
        </div>
        ...
        {state?.success && (
          <div className="p-4 bg-green-500/10 border border-green-500/20 rounded-2xl text-green-500 text-sm font-bold text-center">
            {state.success}
          </div>
        )}
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input 
                ...
                className="w-full pl-12 pr-4 py-4 bg-neutral-900 border border-white/5 rounded-2xl focus:border-violet-500 focus:ring-1 focus:ring-violet-500 outline-none transition-all placeholder:text-neutral-700"
              />
            </div>
          </div>
